...
LexiconKit is a UI-agnostic vocabulary domain package. Read [README.md](README.md) and the DocC catalog before changing public behavior.

Keep dictionary lookup, translation, exercises, persistence frameworks, synchronization, and UI outside the package. Favor stable identifiers and persistence-friendly `Codable`, `Sendable` values.
